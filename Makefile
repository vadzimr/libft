...
SRC    =  ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_calloc.c \
          ft_isascii.c ft_isdigit.c ft_isprint.c ft_itoa.c \
          ft_lstadd.c  ft_lstdel.c ft_lstdelone.c \
          ft_lstiter.c ft_lstmap.c ft_lstnew.c \
          ft_memalloc.c ft_memccpy.c ft_numlen.c ft_isnegative.c ft_max.c ft_print_bits.c \
          ...
          ft_putstr_fd.c ft_stpcpy.c ft_stpncpy.c ft_strcat.c ft_strchr.c ft_strclr.c \
...
OBJ    =  ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_calloc.o \
          ...
          ft_memalloc.o ft_memccpy.o ft_numlen.o ft_isnegative.o ft_max.o ft_print_bits.o \
          ft_memchr.o ft_memcmp.o ft_memcpy.o ft_memdel.o ft_memmove.o \
          ft_memset.o ft_numlen.o ft_putchar.o ft_putchar_fd.o ft_putendl.o \
          ft_putendl_fd.o ft_putnbr.o ft_putnbr_fd.o ft_putstr.o \
          ft_putstr_fd.o ft_stpcpy.o ft_stpncpy.o ft_strcat.o ft_strchr.o ft_strclr.o \
